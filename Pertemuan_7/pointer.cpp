...
void penjumlahanPointer(int* a, int* b) { // menerima alamat
    *a += *b;
    cout << *a << endl;
}
...
int main() {
    ...
    *pointer_num += 5;
    ...
    penjumlahanPointer(&num1, &num2); // memberi alamat dari num1 dan num2 sebagai argumen
    cout << num1 << endl;
    cout << num2 << endl;

    //? Pointer in Pointer
    int score = 4;
    int* pointer_score = &score; // mengambil alamat dari variabel score
    int** ptr_pointer_score = &pointer_score; // mengambil alamat dari alamat variabel score
