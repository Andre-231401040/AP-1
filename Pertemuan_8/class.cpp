...
class Mahasiswa {
    ...
    public:
        ...
        string getName() {
            return this->nama; // this->nama adalah nama yang diperoleh dari class yang sama dengan fungsi ini
        }
...
int main() {
    ...
    Mahasiswa siswa1("Andi", "231401111", 45.6); // instansiasi siswa1
    siswa1.display();
    ...
    for(int i = 0; i < n; i++) {
        cout << "Mahasiswa " << i + 1 << endl;
        mahasiswa[i].display(); // memanggil fungsi display dari mahasiswa[i]
    }
